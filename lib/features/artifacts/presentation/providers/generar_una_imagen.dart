...
final generarUnaImagenProvider =
    Provider<Future<LoQueSalio> Function(String, String?)>((ref) {
      return (descripcion, perfil) async {
        ...
        final llave = await ref.read(geminiImageKeyStoreProvider).read(perfil);
